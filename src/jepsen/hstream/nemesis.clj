...
(defn find-alive-nodes [test] (into [] (filter is-node-alive (:nodes test))))

(defn find-dead-nodes [test] (into [] (filter is-node-dead (:nodes test))))

(defn nemesis+
  []
  (reify
    nemesis/Nemesis
      (nemesis/setup! [this test] this)
